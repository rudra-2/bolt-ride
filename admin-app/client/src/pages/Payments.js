...
export default function Payments() {
  ...
  // Removed methodFilter since we no longer track payment methods
  ...
  const filteredPayments = payments.filter((payment) => {
    ...
    // Removed payment method filtering
  ...
  // Removed getMethodIcon function since we no longer track payment methods
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="flex flex-col md:flex-row gap-4 mb-6">
          ...
          {/* Removed payment method filter since we no longer track payment methods */}
        </div>
